...
# -*- coding: utf-8 -*-
#
# supersmoother documentation build configuration file, created by
...
htmlhelp_basename = 'supersmootherdoc'
...
latex_documents = [
  (master_doc, 'supersmoother.tex', 'supersmoother Documentation',
...
man_pages = [
    (master_doc, 'supersmoother', 'supersmoother Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'supersmoother', 'supersmoother Documentation',
   author, 'supersmoother', 'One line description of project.',
   'Miscellaneous'),
]
